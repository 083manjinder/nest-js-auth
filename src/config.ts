...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8080';
  'jhipster.clientApp.name' = 'moneyTracker';
  ...
  'jhipster.mail.from' = 'moneyTracker@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'moneyTracker API';
  'jhipster.swagger.description' = 'moneyTracker API documentation';
  ...
  'eureka.instance.appname' = 'moneyTracker';
  'eureka.instance.instanceId' = 'moneyTracker:${random.value}';
  ...
  'cloud.config.name' = 'moneyTracker';
